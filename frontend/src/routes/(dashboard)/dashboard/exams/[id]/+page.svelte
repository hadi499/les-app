...
>
  <div class="flex items-center gap-4 mb-8">
    <a
      ...
      aria-label="Kembali"
      class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all shadow-sm"
    >
