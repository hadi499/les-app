    ...
    >
      ...
      <div class="flex items-center gap-2 w-full sm:w-auto">
        ...
        <button
          ...
          class="flex-1 sm:flex-none px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-xl transition-colors cursor-pointer"
        >
          Edit Catatan
        </button>
