      ...
      {#each quotes as q, i}
        <div class="{
          ...
          <div>
            ...
            <!-- English quote -->
            <p class="text-slate-900 font-semibold text-base leading-relaxed mb-3 italic">&ldquo;{q.quote}&rdquo;</p>
            <!-- Indonesian translation -->
            <p class="text-slate-500 text-sm leading-relaxed mb-6 border-t border-slate-200/70 pt-3">{q.arti}</p>
          </div>
          <!-- Author -->
