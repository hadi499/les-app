  ...
  >
    ...
    <div class="flex flex-col items-center gap-8">
      <div class="flex flex-col gap-6 items-center mt-8 sm:mt-2">
        ...
        <p
          class="text-sm sm:text-base text-slate-500 font-semibold tracking-wide leading-7 text-center max-w-sm sm:max-w-md"
        >
          Tempat belajar modern, interaktif, santai tapi serius.
        </p>
      </div>
