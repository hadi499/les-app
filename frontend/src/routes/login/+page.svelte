...
>
  ...
  <main class="relative z-10 w-full max-w-sm flex flex-col items-center gap-6">
    ...
    <div class="flex flex-col items-center gap-2 text-center">
      <div
        class="w-13 h-13 bg-white border border-slate-400 text-blue-600 rounded-2xl flex items-center justify-center shadow-blue-200 shadow-sm mb-1"
        aria-hidden="true"
      >
        <svg
          width="26"
    ...
    <!-- Card -->
    <div
      class="w-full bg-white rounded-2xl border border-slate-400 shadow-md shadow-blue-100 p-8"
    >
